...
public class MovieOld implements Parcelable {
    ...
    public MovieOld(String ID, String voteAverage, String posterPath, String originalTitle, String overview, String releaseDate) {
        this.ID = ID;
    ...
    public static final Parcelable.Creator<MovieOld> CREATOR = new Parcelable.Creator<MovieOld>() {
        ...
        @Override
        public MovieOld createFromParcel(Parcel parcel) {
            return new MovieOld(parcel);
        }

        @Override
        public MovieOld[] newArray(int i) {
            return new MovieOld[i];
        }
